...
__all__ = ('RegistrationView', 'ProfileView', 'UserChangeView', 'LogoutView', 'PasswordChangeView', 'PasswordChangeDoneView')
...
class PasswordChangeView(BasePasswordChangeView):
    template_name = 'accounts/zmien_haslo.html'


class PasswordChangeDoneView(BasePasswordChangeDoneView):
    template_name = 'accounts/zmien_haslo_done.html'
