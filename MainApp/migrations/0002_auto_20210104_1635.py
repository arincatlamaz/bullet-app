    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numer_domu', models.IntegerField(max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Ocenianie',
            fields=[
                ('ocena_id', models.IntegerField(max_length=50, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Role',
            fields=[
                ('role_id', models.IntegerField(max_length=50, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Trasa',
            fields=[
                ('trasa_id', models.IntegerField(max_length=50, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Uzytkownik',
            fields=[
                ('uzytkownik_id', models.IntegerField(max_length=50, primary_key=True, serialize=False)),
